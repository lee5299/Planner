...
export function AuthScreen(){
 ...
 async function submit(event:FormEvent){
  ...
  if(mode==='signup'&&password.length<authSecurityConfig.minimumPasswordLength){
   setError(`비밀번호는 ${authSecurityConfig.minimumPasswordLength}자 이상으로 입력해 주세요.`);return;
  }
  setBusy(true);
  try{
